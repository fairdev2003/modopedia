export const translations: any = {
  pl: {
    Dashboard: {
      ...
      "Permission error":
        "Ta przestrzeń robocza nie jest dostępna, ponieważ twoja rola jest zbyt niska. Spróbuj zalogować się na konto z rolą Admina lub wyższą.",
      You: "Ty",
      Roles: "Role",
    ...
    Mainpage: {
      ...
      InfoSection: {
        ...
        Description:
          "Mody zawsze były interesujące. Bez względu na to, który mod jest Twoim ulubionym, zawsze dostarczymy Ci pełnych informacji na temat tego przedmiotu. Przekażemy Ci również najświeższe informacje na temat przedmiotu. Chcesz wiedzieć więcej?",
        "Search Mods": "Szukaj modyfikacji",
        Search: "Szukaj...",
        "Search Items": "Szukaj przedmiotów",
        "Card Title": "Bądź na bieżąco!",
        "Card Description":
          "Dostawaj świeże dane. Szukaj przedmiotu tutaj lub wykorzystaj nasze API do swojej aplikacji i daj czadu!",
      ...
      LiveChatPresentSection: {
        ...
        "Live Chat Description":
          "Kiedy serwer ma zainstalowaną modyfikację, możesz przeglądać wiadomości, powiadamiać, jeśli gracz dołączył lub opuścił serwer. Gracze mogą udostępniać przedmioty na czacie, a przedmiot zostanie wyświetlony ze wszystkimi zaklęciami i innymi atrybutami danego przedmiotu (mana, energia). Idealna modyfikacja dla osób, które chcą komunikować się z innymi graczami, nie będąc bezpośrednio na serwerze. Poniżej zamieszczę kilka przykładów, jak to działa na podstawie moich testów:",
      },
      ApiSection: {
        ...
        "Get Logistical Storage (AE2, Refined Storage)":
          "Pobierz dane z logistycznego systemu (AE2, Refined Storage)",
      ...
      ComingSoonSection: {
        ...
        ComingSoonDescription:
          "Pracujemy nad kolejnymi funkcjami i ulepszeniami, aby Twoje doświadczenie było lepsze. Naszym celem jest sprawienie, aby wspólne granie było lepsze niż kiedykolwiek wcześniej. Na naszej liście do zrobienia mamy system handlu z graczami - możesz kupować/sprzedawać przedmioty bezpośrednio na stronie, nawet nie będąc na serwerze. Kolejną rzeczą jest ułatwienie moderacji serwera, gdy nie jesteś online - banowanie/wyrzucanie graczy, sprawdzanie, czy serwer jest online zdalnie na swoim telefonie. Bądźcie czujni na nowe aktualizacje!",
      },
      AccountSection: {
        Title: "Kilka serwerów? Nie ma problemu!",
        Description:
          "Możesz przechodzisz pomiędzy kontami jednym kliknięciem. Nie ma potrzeby do logowania sie kilka razy. Co nie że super?",
      ...
      AboutMeSection: {
        Title: "O autorze",
        Description:
          "Hej, nazywam się Jakub. Moją pasją jest programowanie aplikacji fullstackowych. Aktualnie mieszkam w Polsce . Lubię tworzyć nowe projekty i uczyć się nowych technologii. Ten projekt jest moim największym. Chcę, aby ta strona była komercyjna co za tym idzie chciałbym kazdą rzecz dopiąć na ostatny guzik. W trakcie rozwoju będę zamieszczał informacje o postępach na Twitterze, więc jeśli jesteś zainteresowany, sprawdź moje linki poniżej!",
      },
      Footer: {
        FirstColumn: [
          "Mody",
      ...
      Social: {
        ...
        Description:
          "Dołącz do naszej społeczności i dziel się swoimi dziełami z innymi ludźmi! Twoje budowle, mody i inne dzieła będą dostępne dla wszystkich do zobaczenia. Możesz również odkrywać dzieła innych ludzi i inspirować się nimi, aby stworzyć własne arcydzieła!",
      },
      ContactUs: {
  ...
  en: {
    Dashboard: {
      ...
      "Permission error":
        "This workspace is not available because your role is too low. Try logging in to an account with an Admin or higher role.",
    ...
    Mainpage: {
      ...
      InfoSection: {
        ...
        Description:
          "Mods have always been interesting. No matter what mod is your favorite, we will always provide you with complete information about this item. We will also provide you with the latest news about the item, wanna know more?",
        "Search Mods": "Search Mods",
        Search: "Search...",
        "Search Items": "Search Items",
        "Card Title": "Stay up to date!",
        "Card Description":
          "Get fresh data. Search for item here or get our API to your application and make rock!",
      ...
      LiveChatPresentSection: {
        ...
        "Live Chat Description":
          "When server has mod installed, you can view messages, notify if player joined or left. Players can share items on the chat and itemn will be displayed with all enchanments and stuff (mana, energy). Perfect mod for people who want to communicate with other players without being directly on the server. Below i will post some examples how it works from my tests:",
      },
      ApiSection: {
        ApiSectionTitle: "API Usage",
        ApiSectionDescription:
          "Our API is available for everyone who wants to use our data in their application. We provide full data about items, mods, tags and many more! All in one place. Just contact us and we will provide you API key that will allow you to use our data!",
      ...
      AboutMeSection: {
        Title: "About Author",
        Description:
          "Hey, my name is Jakub. Im pasionate fullstack developer from Poland. I do like make new projects. This project is my biggest. I want to make this website smooth. Along the development i will post news about progress on Twitter so if you are hyped, check my links below!",
      },
      Footer: {
        FirstColumn: [
          "Mods",
      ...
      Social: {
        ...
        Description:
          "Join our community and share your creations with other people! Your images, mods, and other creations will be available for everyone to see. You can also explore other people's creations and get inspired by them to create your own beatiful art!",
      },
  ...
  es: {
    Dashboard: {
      ...
      "Permission error":
        "Este espacio de trabajo no está disponible porque tu rol es demasiado bajo. Intenta iniciar sesión en una cuenta con un rol de Admin o superior.",
      "Dashboard Stats": "Estadísticas del panel",
      "Dashboard Stats desc":
        "¡Súper gráficos para las estadísticas del panel!",
    ...
    Mainpage: {
      ...
      InfoSection: {
        ...
        Description:
          "Los mods siempre han sido interesantes. No importa cuál sea tu mod favorito, siempre te proporcionaremos información completa sobre este artículo. También te proporcionaremos las últimas noticias sobre el artículo, ¿quieres saber más?",
        "Search Mods": "Buscar mods",
        "Search Items": "Buscar artículos",
        Search: "Buscar...",
        "Card Title": "¡Mantente al día!",
        "Card Description":
          "¡Obtén datos frescos. Busca el artículo aquí o consigue nuestra API para tu aplicación y haz que rockee!",
      ...
      Social: {
        ...
        Description:
          "¡Únete a nuestra comunidad y comparte tus creaciones con otras personas! Tus imágenes, mods y otras creaciones estarán disponibles para que todos las vean. ¡También puedes explorar las creaciones de otras personas e inspirarte en ellas para crear tu propia obra maestra!",
      },
